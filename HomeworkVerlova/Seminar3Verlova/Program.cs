...
// Console.WriteLine("Расстояние между точками составляет "+ Math.Round(GetLength(x1Input, y1Input, z1Input, x2Input, y2Input, z2Input), 2));
